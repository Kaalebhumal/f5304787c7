...
window.COURSE_DATA.marketing = {
  ...
  weeks: [
    { n: 1, title: "What marketing actually is", lessons: [
    ...
    { n: 2, title: "Markets and the environment", lessons: [
    ...
    { n: 3, title: "The consumer mind I", lessons: [
    ...
    { n: 4, title: "The consumer mind II — decisions under real conditions", lessons: [
    ...
    { n: 5, title: "Business and institutional buying", lessons: [
    ...
    { n: 6, title: "Marketing research", lessons: [
    ...
    { n: 7, title: "Segmentation, targeting, positioning", lessons: [
    ...
    { n: 9, title: "Product, innovation and services", lessons: [
    ...
    { n: 11, title: "Place and availability", lessons: [
    ...
    { n: 12, title: "Promotion and integrated communications", lessons: [
    ...
    { n: 13, title: "Digital marketing", lessons: [
    ...
    { n: 14, title: "Measurement and analytics", lessons: [
    ...
    { n: 15, title: "Marketing strategy and management", lessons: [
    ...
    { n: 16, title: "Ethics, frontier, and the capstone", lessons: [
